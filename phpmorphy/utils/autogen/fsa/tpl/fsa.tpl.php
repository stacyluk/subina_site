...
*
* Copyright c 2007-2008 Kamaev Vladimir
<heromantor@users.sourceforge.net>
*
...
list(, $trans) = <?php echo $helper->unpackTrans($helper->storage->read($helper->getRootTransOffset(),
    $helper->getTransSize())) ?>;
