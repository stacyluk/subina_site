...
class Helper extends Helper_Base
{
    ...
    {
        return $this->_processTpl('find_char_in_state');
    }

    function tplUnpackTrans()
    {
        return $this->_processTpl('unpack_trans');
    }

    function tplReadState()
    {
        return $this->_processTpl('read_state');
    }

    function tplExtraFuncs()
    {
        return $this->_processTpl('extra_funcs');
    }

    function tplExtraProps()
    {
        return $this->_processTpl('extra_props');
    }
    ...
    function _getIndexByTrans($transVar, $charVar)
    {
        return '--ABSTRACT--';
    }

    function _getAnnotIndexByTrans($transVar)
    {
        return '--ABSTRACT--';
    }
}
...
class Helper_Tree extends Helper
{
    ...
    function _getAnnotIndexByTrans($transVar)
    {
        return $this->_getIndexByTrans($transVar, '--INVALID--');
    }
}
