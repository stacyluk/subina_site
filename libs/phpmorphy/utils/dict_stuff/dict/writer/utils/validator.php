...
class phpMorphy_Dict_Writer_Utils_Validator
{
    ...
    function setFlexiasCount($count)
    {
        $this->flexias_count = (int) $count;
    }

    function setAccentsCount($count)
    {
        $this->accents_count = (int) $count;
    }

    function setSessionsCount($count)
    {
        $this->sessions_count = (int) $count;
    }

    function setPrefixesCount($count)
    {
        $this->prefixes_count = (int) $count;
    }
    ...
    {
        return (int) $id < $this->flexias_count;
    }

    function validateAccentId($id)
    {
        return (int) $id < $this->accents_count;
    }

    function validateSessionId($id)
    {
        return (int) $id < $this->sessions_count;
    }

    function validatePrefixId($id)
    {
        return (int) $id < $this->prefixes_count;
    }

    function validateAncodeId($id)
    {
        return isset($this->ancodes_map[$id]);
    }
}
