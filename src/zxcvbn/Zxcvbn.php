...
namespace ZxcvbnPhp;
require_once __DIR__.DIRECTORY_SEPARATOR.'Scorer.php';
require_once __DIR__.DIRECTORY_SEPARATOR.'Searcher.php';
require_once __DIR__.DIRECTORY_SEPARATOR.'Matcher.php';
